...
def get_best_airport_for_country(country_code: str):
    ...
    # Handle multiple preferred airports
    if isinstance(preferred, list):
        for airport_code in preferred:
            if airport_code in AIRPORTS:
                return airport_code

    # Handle a single preferred airport
    elif preferred and preferred in AIRPORTS:
        return preferred
